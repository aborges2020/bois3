                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-right">
                            <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> Add Point of Sale</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#data_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                    action_url = "/admin/pos";
                }

                if($('#action').val() == 'Edit')
                {
                    action_url = "/admin/pos/update";
                }
