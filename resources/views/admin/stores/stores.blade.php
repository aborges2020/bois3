                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-right">
                            <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> Add Store</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="stores_table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>id</th>
                                    <th>Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#data_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                    action_url = "/admin/stores";
                }

                if($('#action').val() == 'Edit')
                {
                    action_url = "/admin/stores/update";
                }
