                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-right">
                            <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> Add Client</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
        ...
        $(document).ready(function(){
                ...
                $('#data_form').on('submit', function(event){
                    ...
                    if($('#action').val() == 'Edit')
                    {
                        ...
                        action_url = "/admin/clients/update";
                    }
