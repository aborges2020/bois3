                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-right">
                            <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> Add Suppliers</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4">Celphone</label>
                            <div class="col-md-8">
                                <input type="text" name="cel_number" id="cel_number" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#data_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Edit')
                {
                    action_url = "/admin/suppliers/update";
                }
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('#contact_name').val(data.result.contact_name);
                        $('#email').val(data.result.email);
                        $('#tel_number').val(data.result.tel_number);
                        $('#cel_number').val(data.result.cel_number);
            ...
            $('#ok_button').click(function(){
                $.ajax({
                    url:"/admin/suppliers/destroy/" + id,
                    beforeSend:function(){
