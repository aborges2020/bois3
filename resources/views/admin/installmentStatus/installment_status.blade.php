...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Installment Status</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin') }}">Admin</a></li>
                        <li class="breadcrumb-item active">Installment Status</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-right">
                            <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> Add Status</button>
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#data_form').on('submit', function(event){
                ...
                if($('#action').val() == 'Add')
                {
                    action_url = "/admin/installment-status";
                }

                if($('#action').val() == 'Edit')
                {
                    action_url = "/admin/installment-status/update";
                }
            ...
            $(document).on('click', '.edit', function(){
                ...
                $('#form_result').html('');
                $.ajax({
                    url :"/admin/installment-status/" + id + "/edit",
                    dataType:"json",
                    success:function(data)
                    {
            ...
            $('#ok_button').click(function(){
                $.ajax({
                    url:"/admin/installment-status/destroy/" + id,
                    beforeSend:function(){
